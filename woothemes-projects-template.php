 ...
 * @return void
 */
function woothemes_projects_template_redirect() {
	global $wp_query, $wp;

	// Redirect project base page to post type archive url
	if ( is_page( woothemes_projects_get_page_id( 'showcase' ) ) ) {
 ...
 * @return array
 */
function woothemes_projects_nav_menu_item_classes( $menu_items, $args ) {

	if ( ! is_woothemes_projects() ) return $menu_items;

	$projects_page 	= (int) woothemes_projects_get_page_id( 'showcase' );
